...
read_data_attr_h5 <- function(h5file, groupname, dataname, attr_name) {
    .Call('RcppEigenH5_read_data_attr_h5_exp', PACKAGE = 'RcppEigenH5', h5file, groupname, dataname, attr_name)
}
